...
class TripMetricsCalculator @Inject constructor() {
    ...
    /** Great-circle distance on a spherical earth approximation — adequate at motorcycle-trip scale, and exactly the kind of pure geometry ADR-013 allows in domain/ (no android.location.Location call). */

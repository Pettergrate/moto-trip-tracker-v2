...
**Status:** Phase 0 documentation closed (GO, F0.17); Phase 1 implementation underway — **Wave W0 and Wave W1 both complete** (`TRK-001`, `TRK-002`, `TRK-003`, `TRK-004`, `PRC-001`, `PRC-002`, `UI-001`, `HIS-001`, `PRC-003`, `NOT-001` (on-device verification closed 2026-09-21), `REC-001`, `MAP-001` done); Wave W2 started early (`DET-001`, `DET-002`, `DET-003`, `AUTO-001`, `DET-004`, `DET-005`, `DET-006`, `DET-007` done; `EXP-002`/`EXP-003` harness+profile-switching done, real pilot rides in progress; `REF-001`/`REF-002` V1 parity/migration design done); Wave W3 started early (`TRS-001`, `FAV-001`, `MET-001` done); Wave W4's `PERM-001` started early too (narrow Start-crash guard done 2026-09-22, full onboarding scope still open)  
**Version:** 0.46
